...
public class RedmineJSONParser {
	...
	public static TimeEntry parseTimeEntry(JSONObject object)
		...
		result.setCustomFields(JsonInput.getListOrNull(object, "custom_fields", CUSTOM_FIELD_PARSER));
	...
	public static Project parseProject(JSONObject content) throws JSONException {
		...
		result.setCustomFields(JsonInput.getListOrNull(content, "custom_fields", CUSTOM_FIELD_PARSER));
