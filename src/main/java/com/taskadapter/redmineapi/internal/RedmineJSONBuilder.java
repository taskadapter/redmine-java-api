...
public class RedmineJSONBuilder {
    ...
    static void writeTimeEntry(JSONWriter writer, TimeEntry timeEntry) throws JSONException {
        ...
        JsonOutput.addIfNotNull(writer, "activity_id", timeEntry.getActivityId());
     ...
     * @param tracker tracker to writer.
     * @throws JSONException if error occurs.
     */
    static void writeTracker(JSONWriter writer, Tracker tracker) throws JSONException {
        writer.key("id");
    ...
    static void writeVersion(JSONWriter writer, Version version) throws JSONException {
        ...
        if (version.getProject() != null) {
            JsonOutput.addIfNotNull(writer, "project_id", version.getProject().getId());
        }
        JsonOutput.addIfNotNull(writer, "name", version.getName());
        JsonOutput.addIfNotNull(writer, "description", version.getDescription());
    ...
    public static void writeIssue(final JSONWriter writer, Issue issue) throws JSONException {
        ...
        if (issue.getProject() != null) {
            ...
            if (issue.getProject().getId() != null) {
                JsonOutput.addIfNotNull(writer, "project_id", issue.getProject().getId());
            } else {
        ...
        if (Version.EMPTY_VERSION == issue.getTargetVersion()) {
            JsonOutput.addIfNotNull(writer, "fixed_version_id", "");
        ...
        final List<Attachment> uploads = issue.getAttachments().stream().filter(attachment -> attachment.getToken() != null)
     ...
     * 
     * @param writer writer to add object to.
     * @param field field name to set.
     * @param value field value.
     * @throws JSONException if io error occurs.
     */
    public static void addIfNotNullFull(JSONWriter writer, String field, Date value) throws JSONException {
     ...
     * @throws JSONException if io error occurs.
     */
    public static void addFull(JSONWriter writer, String field, Date value) throws JSONException {
        final SimpleDateFormat format = RedmineDateParser.FULL_DATE_FORMAT.get();
     ...
     * @throws JSONException if io error occurs.
     */
    public static void addIfNotNullShort(JSONWriter writer, String field, Date value) throws JSONException {
        final SimpleDateFormat format = RedmineDateParser.SHORT_DATE_FORMAT.get();
        JsonOutput.addIfNotNull(writer, field, value, format);
    }
     ...
     * @throws JSONException if io error occurs.
     */
    public static void addIfNotNullShort2(JSONWriter writer, String field, Date value) throws JSONException {
     ...
     * @throws JSONException if io error occurs.
     */
    public static void addShort2(JSONWriter writer, String field, Date value) throws JSONException {
        final SimpleDateFormat format = RedmineDateParser.SHORT_DATE_FORMAT_V2.get();
        JsonOutput.add(writer, field, value, format);
    }
}
