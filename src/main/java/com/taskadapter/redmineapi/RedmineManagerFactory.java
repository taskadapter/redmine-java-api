...
public final class RedmineManagerFactory {
	 ...
	 *            redmine manager URI.
	 * @param options
	 *            additional redmine manager options.
	...
	static TransportConfiguration parseOptions(RedmineOptions options) {
		...
		return createLongTermConfiguration(connManager,
				options.getIdleTimeout(), options.getEvictionCheckInterval());
	}
	 ...
	 * @param idleTimeout
	 *            idle timeout for connection before eviction, seconds.
	 * @param evictionCheck
